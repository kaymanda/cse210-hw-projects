...
class Program
{
    static void Main(string[] args)
    {
        ...
        // need to use get?
        Scripture pickedScript = new Scripture(favoriteScriptures[number].GetScripture(), favoriteScriptures[number].GetScripture().GetDisplayText());
        ...
        while ((press != "quit"))
        {
            ...
            Console.Clear();
            // use get
            string scriptureChoice = pickedScript.GetScripture().GetDisplayText();
